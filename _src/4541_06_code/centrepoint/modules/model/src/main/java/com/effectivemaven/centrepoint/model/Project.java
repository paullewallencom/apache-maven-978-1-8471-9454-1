...
public class Project
{
    ...
    public boolean equals( Object obj )
    {
        ...
        return new EqualsBuilder()
            .append( this.ciManagementUrl, rhs.ciManagementUrl )
            .append( this.description, rhs.description )
            .append( this.extensionModels, rhs.extensionModels )
            .append( this.id, rhs.id )
            .append( this.issueTrackerUrl, rhs.issueTrackerUrl )
            .append( this.name, rhs.name )
            .append( this.repositoryUrl, rhs.repositoryUrl )
            .append( this.scmUrl, rhs.scmUrl )
            .append( this.snapshotRepositoryUrl, rhs.snapshotRepositoryUrl )
    ...
    public int hashCode()
    {
        return new HashCodeBuilder()
            .append( ciManagementUrl )
            .append( description )
            .append( extensionModels )
            .append( id )
            .append( issueTrackerUrl )
            .append( name )
            .append( repositoryUrl )
            .append( scmUrl )
            .append( snapshotRepositoryUrl )
            .append( url )
            .append( version )
            .toHashCode();
    }
